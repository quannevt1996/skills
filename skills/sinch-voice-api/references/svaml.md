> **Not a schema.** This file describes the available SVAML actions and instructions and when
> to use them. For payload shape (field names, nesting, encodings, enums), refer to the
