> **Not a schema.** This file describes the Inspect endpoints, when to use them, and their
> pitfalls. For payload shape (field names, nesting, encodings, enums), refer to the canonical
