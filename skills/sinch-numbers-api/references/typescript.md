> **Not a schema.** This file shows TypeScript/Node.js usage patterns for the Numbers SDK. For
> SDK method signatures and payload shape (field names, nesting, encodings, enums), refer to
